        ...
        <table class="min-w-full bg-white">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $mhs->alamat }}</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $mhs->tanggal_lahir }}</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $mhs->no_telepon }}</td>
